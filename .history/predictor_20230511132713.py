...
model = tf.keras.models.load_model(r"E:\College\Sem 6\Mini Project\emotion_model_trained.h5")

@app.route('/')
def home():
    return render_template(r'E:\College\Sem_6\Mini_Project\index.html')
...
def predict():
    ...
    return render_template(r'E:\College\Sem_6\Mini_Project\result.html', emotion=predicted_emotion)
