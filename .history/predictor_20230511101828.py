...
model = tf.keras.models.load_model(r"E:\College\Sem 6\Mini Project\emotion_model_trained_2.h5")

# Define the route and function for the home page
@app.route('/')
def home():
    return render_template('index.html')

# Define the route and function for the prediction
